...
const FAQ = () => {
  ...
  return (
    <section className="py-24 px-24 bg-white overflow-hidden">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          
          {/* Left Content - FAQ Accordion */}
          <div className="lg:col-span-7 space-y-10">
            <h2 className="text-4xl md:text-5xl font-heading font-medium text-gray-800 leading-tight">
            ...
            <div className="space-y-2">
              {faqs.map((faq, index) => (
                <div key={index} className="border-b border-gray-300 last:border-0 pb-2">
                  ...
                  >
                    <span className={`text-lg md:text-lg font-heading font-medium transition-colors ${
